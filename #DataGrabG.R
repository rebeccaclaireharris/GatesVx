...
yngwane<-as.matrix(read.csv('vaccwaneyng_4yCU.csv',header=TRUE, check.names=F))
oldwane10<-as.matrix(read.csv('vaccwaneold10.csv',header=TRUE, check.names=F))
yngwane10<-as.matrix(read.csv('vaccwaneyng10_4yrCU.csv',header=TRUE, check.names=F))

oldwaneto0<-as.matrix(read.csv('vaccwaneold10_0wane.csv',header=TRUE, check.names=F))
#oldwaneto1<-as.matrix(read.csv('vaccwaneold_to1.csv',header=TRUE, check.names=F))
oldwaneto5<-as.matrix(read.csv('vaccwaneold_to5_10.csv',header=TRUE, check.names=F))
